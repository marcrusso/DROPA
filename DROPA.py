...
try:
    ...
    bruno6=ex.TableCreator(FeatureAssignUnderResults,namepeak=data2,lap='NotExpressed')
...
if fileOver != "None":
    if fileUnder != "None":
        ...
        with open('./' + data2 + '/' + data2 + '_Annotation.table', 'w') as outfile:
                ...
                with open(fname) as infile:
                    for line in infile:
                        if h==1:
                            ...
                            h=1
                    h=0
        with open("./" + data2 + "/All_results" + data2 + ".csv", 'w') as outfile:
            h=1
